...
diretores = sorted(df['direção'].dropna().unique())
...
if diretor_selecionado:
    df_filtrado = df_filtrado[df_filtrado['direção'].isin(diretor_selecionado)]
...
col3.metric("🎥 Diretores Únicos", df_filtrado['direção'].nunique())
